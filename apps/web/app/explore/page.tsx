...
const SHOW_EXPLORE_PAGE = true; // Feature flag for the entire page
const SHOW_PROPERTY_TABS = false; // Feature flag for Buy/Rent/PG tabs
...
export default function ExplorePage() {
  ...
  return (
    <div className="flex-1 p-4 sm:p-6 w-full">
      <h1 className="text-3xl font-extrabold mb-4 text-black">Explore Properties</h1>
