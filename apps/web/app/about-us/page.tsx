          ...
          <div className="container mx-auto px-6">
            ...
            <div className="border-l-4 border-blue-500 pl-6 py-4 bg-blue-100 rounded-r-xl shadow-lg mx-auto max-w-5xl animate-fade-in-up delay-200">
              <ul className="list-disc list-inside text-blue-800 space-y-3 text-lg">
                ...
                <li>Eliminate hidden costs and brokerage fees making the rental process transparent and fair.</li>
                <li>Empower property owners with easy tools to manage and rent out their spaces hassle-free.</li>
                <li>Offer essential services like food (cloud kitchen) and laundry - all from a single app.</li>
                <li>Create a trusted digital ecosystem that supports stress-free, long term living solutions.</li>
                <li>Community built on safety, comfort and support where we uplift and offer shelter.</li>
              </ul>
            </div>
          </div>
        </section>
